...
function calc() {
  var gender = document.querySelectorAll('[data-gender]');
  var inputs = document.querySelectorAll('[data-calc-inputs]');
  var activity = document.querySelectorAll('[data-activity]');
  var calcValue = document.querySelector('.calculating__result span');
  var calcDB = {
  ...
  var changeValue = function changeValue(obj) {
    if (checkValue(obj)) {
      var result = 0;
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(imageSrc, alt, title, description, price, parentSelector) {
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        element.innerHTML = "\n                <div class=\"menu__item\">\n                    <img data-menu-img src=".concat(this.imageSrc, " alt=").concat(this.alt, ">\n                    <h3 class=\"menu__item-subtitle\">").concat(this.title, "</h3>\n                    <div class=\"menu__item-descr\">").concat(this.description, "</div>\n                    <div class=\"menu__item-divider\"></div>\n                    <div class=\"menu__item-price\">\n                        <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                        <div class=\"menu__item-total\"><span class=\"span-price\">").concat(this.price, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n                    </div>\n                </div>\n            ");
...
/* harmony import */ var _spinner__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./spinner */ "./js/modules/spinner.js");
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      postData('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
        (0,_spinner__WEBPACK_IMPORTED_MODULE_9__.default)(messages.success, modalSelector);
        statusMessage.remove();
      })["catch"](function () {
        (0,_spinner__WEBPACK_IMPORTED_MODULE_9__.default)(messages.failure, modalSelector);
      })["finally"](function () {
        form.reset();
      });
    });
...
var showModalWindow = function showModalWindow(modalSelector) {
...
var closeModalWindow = function closeModalWindow(modalSelector) {
  var modalWindow = document.querySelector(modalSelector);
...
function modal(triggerSelector, modalSelector, closeSelector) {
  var showModalElement = document.querySelectorAll(triggerSelector);
  var modalWindow = document.querySelector(modalSelector);
  var closeModalWindowElement = document.querySelector(closeSelector);
  showModalElement.forEach(function (element) {
    element.addEventListener('click', function () {
      showModalWindow(modalSelector);
    });
  });
  closeModalWindowElement.addEventListener('click', function () {
  ...
  var modalTimer = 50000;
  var modalTimeOut = setTimeout(function () {
    showModalWindow(modalSelector);
  }, modalTimer);

  var showModalScroll = function showModalScroll() {
...
function slider() {
  var slideElement = document.querySelector('.offer__slider-wrapper img'),
  ...
  axios.get('http://localhost:3000/slides').then(function (data) {
    var totalSlideNumber = "" + Object.entries(data.data[0]).length;
    totalSlidesCount.innerHTML = "0".concat(totalSlideNumber);
  });
  nextSlideButton.addEventListener('click', function () {
    if (currentSlideNumber != 4) {
      ...
      currentSlideCount.innerHTML = "0".concat(currentSlideNumber);
  ...
  dots.forEach(function (item) {
    item.addEventListener('click', function (event) {
      ...
      var index = dots.indexOf(event.target) + 1;
      axios.get('http://localhost:3000/slides').then(function (data) {
        slideElement.classList.add('fade');
        slideElement.src = data.data[0]["slide_" + index];
      });
      currentSlideCount.innerHTML = "0".concat(index);
      slideElement.classList.remove('fade');
...
var showThanksModal = function showThanksModal(message, modalSelector) {
  var prevModalDialog = document.querySelector('.modal__dialog');
  prevModalDialog.classList.add('hide');
  (0,_modal__WEBPACK_IMPORTED_MODULE_1__.showModalWindow)(modalSelector);
  ...
  setTimeout(function () {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_1__.closeModalWindow)(modalSelector);
  }, 4000);
};
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.default)('[data-modal]', '.modal', '.modal__close');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_3__.default)();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_4__.default)();
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_5__.default)();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_6__.default)('.modal');
});
})();
